...
class NetsuiteCustomRecordSavedSearchV1
  # ==== Parameters
  ...
  def execute
    ...
    basic_array = @search
    puts "Adding custom record search to basic criteria." if @debug_logging_enabled
    # Push the custom record search into the basic array to limit search to one form.
