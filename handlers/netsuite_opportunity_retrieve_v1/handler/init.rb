...
class NetsuiteOpportunityRetrieveV1
  # ==== Parameters
  ...
  def execute
    ...
    begin
      puts "Retrieving opportunity with internal id of #{@internal_id}." if @debug_logging_enabled
      # Perform search
      response = NetSuite::Records::Opportunity.get(
